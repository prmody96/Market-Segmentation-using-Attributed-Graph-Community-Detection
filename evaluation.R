...
# ===== Reading the graph ====== #
#"C:\Users\prana\Desktop\SEMESTER2\ADBI\Project 7 (Market.Segmentation.AttributedGraph Communities Assignment)\data"
#g <- read.graph(file="data/fb_caltech_small_edgelist.txt", format = c("edgelist"))
g <- read.graph(file="C://Users//prana//Desktop//SEMESTER2//ADBI/Project 7 (Market.Segmentation.AttributedGraph Communities Assignment)//data//fb_caltech_small_edgelist.txt", format = c("edgelist"))
# ===== Read communities file ==== #
comm = integer(vcount(g))

conn <- file("C://Users//prana//Desktop//SEMESTER2//ADBI/Project 7 (Market.Segmentation.AttributedGraph Communities Assignment)//communities.txt", open="r")
...
attrData <- read.csv("C://Users//prana//Desktop//SEMESTER2//ADBI/Project 7 (Market.Segmentation.AttributedGraph Communities Assignment)//data//fb_caltech_small_attrlist.csv")
